...
// 수민이는 1시간 동안 남은 일 중 하나를 골라 작업량 1만큼 처리할 수 있습니다. 수민이의 퇴근까지 남은 N 시간과 각 일에 대한 작업량이 있을 때, 
// noOvertime 함수를 제작하여 수민이의 야근 지수를 최소화 한 결과를 출력해 주세요. 예를 들어, N=4 일 때, 
// 남은 일의 작업량이 [4, 3, 3] 이라면 
...
console.log(noOvertime(5,[1,1,1,2,5]));
console.log(noOvertime(5,[1,2,3,4,5]));